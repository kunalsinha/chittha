...
class Ui_TabWidget(object):
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.label_2.setText(_translate("TabWidget", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">Chittha v1.0</span></p><p align=\"center\"><span style=\" font-weight:600;\">Keyboard Shortcuts</span></p><p align=\"center\">Ctrl + N -&gt; New note</p><p align=\"center\">Ctrl + J -&gt; Next note</p><p align=\"center\">Ctrl + K -&gt; Previous note</p><p align=\"center\">Ctrl + L -&gt; Lock/Unlock note</p><p align=\"center\">Ctrl + H -&gt; Hide all notes</p><p align=\"center\"><br/></p><p align=\"center\"><a href=\"https://github.com/kunalsinha/chittha\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/kunalsinha/chittha</span></a></p><p align=\"center\">Copyright (C) 2019 Kunal Sinha</p></body></html>"))
